...
/**
 * Install locally using `yarn add @fortawesome/fontawesome-pro:6.0.0-beta2`
 * Add `.copy('./node_modules/@fortawesome/fontawesome-pro/js/all.min.js', 'public/scripts/fontawesome')` inside `webpack.mix.js`
 * Then enqueue it via `wp_enqueue_script('fontawesome', asset('scripts/fontawesome/all.min.js')->uri(), [], null, false);`
 */
class FontAwesome6Fields extends Partial
{
    /**
    ...
    {
        $fontAwesome6Fields = new FieldsBuilder('font_awesome6_fields');
        $fontAwesome6Fields
            ->addSelect('icon', [
                'choices' => self::$icons,
                'default_value' => $this->defaultIcon ?? self::$icons[0],
                'instructions' => 'See <a href="https://fontawesome.com/v6.0/icons?s=solid%2Cbrands" target="_blank">fontawesome.com</a>',
                'ui' => 1,
            ])
            ->addSelect('icon_type', [
                'choices' => self::$types,
                'default_value' => $this->defaultIconType ?? self::$types[0],
                'ui' => 1,
            ]);

        return $fontAwesome6Fields;
    }
