...
final class GravityForms extends AC\Plugin {
	...
	public function table_scripts() {
		wp_enqueue_style( 'aca-gf-table', $this->get_url() . 'assets/css/table.css', [], $this->get_version() );
		wp_enqueue_script( 'aca-gf-table', $this->get_url() . 'assets/js/table.js', [], $this->get_version() );
